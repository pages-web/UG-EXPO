...
export default function CarDetail() {
  ...
  const data = [
    {
      ...
      price: 239000,
      id: 1,
      productType: "Car Tools",
      productCategory: "Car Tire",
      productShowcase: "4 Car Tires",
      productSize: "90 * 90",
  ...
  const selectedCarProduct = data.find((car) => car.id.toString() === id);

  if (!selectedCarProduct) {
      ...
      <div className="mt-[70px] flex w-full flex-col p-8 py-[50px] lg:flex-row">
        ...
        <div className="ml-8 mt-[20px] flex flex-row text-lg xl:ml-16">
          ...
          <div className="ml-[300px] flex-col">
            <p>{selectedCarProduct?.name}</p>
            <p>{selectedCarProduct?.price}</p>
            <p>{selectedCarProduct?.productType}</p>
            <p>{selectedCarProduct?.productCategory}</p>
            <p>{selectedCarProduct?.productShowcase}</p>
            <p>{selectedCarProduct?.productSize}</p>
            <p>{selectedCarProduct?.internetAddress}</p>
            <p>{selectedCarProduct?.phoneNumber}</p>
            <p>{selectedCarProduct?.Address}</p>
            <p>{selectedCarProduct?.moreInformation}</p>
          </div>
        </div>
      </div>
      <div>
